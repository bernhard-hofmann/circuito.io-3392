...
void loop() 
{
    ...
    {
    // Disclaimer: The Piezo Vibration Sensor - Large with Mass #1 is in testing and/or doesn't have code, therefore it may be buggy. Please be kind and report any bugs you may find.
    }
    else if(menuOption == '3')
    {
    // Disclaimer: The Piezo Vibration Sensor - Large with Mass #2 is in testing and/or doesn't have code, therefore it may be buggy. Please be kind and report any bugs you may find.
    }
    ...
    Serial.print(F("Val: ")); Serial.println(ArcadeButtonVal);
...
char menu()
{
    ...
    Serial.println(F("(2) Piezo Vibration Sensor - Large with Mass #1"));
    Serial.println(F("(3) Piezo Vibration Sensor - Large with Mass #2"));
    Serial.println(F("(4) Concave Arcade Button - Red (without LED)"));
    Serial.println(F("(5) Relay Module #1"));
    Serial.println(F("(6) Relay Module #2"));
    ...
    while (Serial.available()) 
    {
        ...
        {   
            ...
            if(c == '1') 
    			...
    			Serial.println(F("Now Testing Piezo Vibration Sensor - Large with Mass #1 - note that this component doesn't have a test code"));
    		else if(c == '3') 
    			Serial.println(F("Now Testing Piezo Vibration Sensor - Large with Mass #2 - note that this component doesn't have a test code"));
    		else if(c == '4') 
    			Serial.println(F("Now Testing Concave Arcade Button - Red (without LED)"));
    		else if(c == '5') 
